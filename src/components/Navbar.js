...
function Navbar() {
  ...
  return (
    <>
    <nav className="navbar" role="navigation" aria-label="Κύρια πλοήγηση">
        <div className="gov-navbar-inner">
        <div className="navbar-brand gov-navbar-brand">
           <Link to="/" className="gov-navbar-brand-link" aria-label="Αρχική — Νταντάδες της Γειτονιάς">
             <span className="gov-logo-wrap">
               <img src={govLogo} alt="" className="gov-navbar-logo" width="120" height="40" />
             </span>
             <span className="gov-service-name">Νταντάδες της Γειτονιάς</span>
           </Link>
         </div>
