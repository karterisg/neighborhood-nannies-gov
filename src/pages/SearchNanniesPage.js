...
function SearchNanniesPage() {
  ...
  if (loading) {
    ...
    <div className="search-nannies-page">
          <p className="page-eyebrow">Για γονείς</p>
          <h2>Αναζήτηση νταντάς</h2>
          <p className="page-lead">Φιλτράρετε με περιοχή, εμπειρία και άλλα κριτήρια. Τα αποτελέσματα ενημερώνονται αυτόματα όταν αλλάζετε τα πεδία.</p>
